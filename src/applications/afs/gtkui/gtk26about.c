...
gtk_about_dialog_class_init (GtkAboutDialogClass *klass)
{
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("name",
							...
							gettext_noop("The name of the program. If this is not set, it defaults to g_get_application_name()"),
							NULL,
							G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("version",
							gettext_noop("Program version"),
							gettext_noop("The version of the program"),
							NULL,
							G_PARAM_READWRITE));
  g_object_class_install_property (object_class,
				   PROP_COPYRIGHT,
				   g_param_spec_string ("copyright",
							gettext_noop("Copyright string"),
							gettext_noop("Copyright information for the program"),
							NULL,
							G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("comments",
							gettext_noop("Comments string"),
							gettext_noop("Comments about the program"),
							NULL,
							G_PARAM_READWRITE));
  g_object_class_install_property (object_class,
				   PROP_LICENSE,
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("website",
							gettext_noop("Website URL"),
							gettext_noop("The URL for the link to the website of the program"),
							NULL,
							G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("website_label",
							gettext_noop("Website label"),
							gettext_noop("The label for the link to the website of the program. If this is not set, it defaults to the URL"),
							NULL,
							G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_boxed ("authors",
						       ...
						       gettext_noop("List of authors of the programs"),
						       G_TYPE_STRV,
						       G_PARAM_READWRITE));
  g_object_class_install_property (object_class,
				   PROP_DOCUMENTERS,
				   g_param_spec_boxed ("documenters",
						       ...
						       gettext_noop("List of people documenting the program"),
						       G_TYPE_STRV,
						       G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_boxed ("artists",
						       ...
						       gettext_noop("List of people who have contributed artwork to the program"),
						       G_TYPE_STRV,
						       G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_string ("translator_credits",
							...
							gettext_noop("Credits to the translators. This string should be marked as translatable"),
							NULL,
							G_PARAM_READWRITE));
  ...
  g_object_class_install_property (object_class,
				   ...
				   g_param_spec_object ("logo",
							gettext_noop("Logo"),
							gettext_noop("A logo for the about box. If this is not set, it defaults to gtk_window_get_default_icon_list()"),
							GDK_TYPE_PIXBUF,
							G_PARAM_READWRITE));
