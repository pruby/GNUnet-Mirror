...
{
	QString s = QFileDialog::getOpenFileName("/etc/GNUnet/.config", NULL, this);
	if (s.isNull())
		return;
...
{
	static char str[] = "Welcome to the qconf graphical GNUnet configuration tool.\n\n"
		"For each option, a blank box indicates the feature is disabled and a check\n"
