...
void GNUNET_RPC_parameters_add_data_container (GNUNET_RPC_CallParameters * param,
                                const char *name, const GNUNET_DataContainer * data);

const char *GNUNET_RPC_parameters_get_name (GNUNET_RPC_CallParameters * param, unsigned int i);

unsigned int GNUNET_RPC_get_index_by_name (GNUNET_RPC_CallParameters * param, const char *name);
 ...
 * @return GNUNET_OK on success, GNUNET_SYSERR on error
 */
int GNUNET_RPC_parameters_get_value_by_index (GNUNET_RPC_CallParameters * param,
                              unsigned int i,
                              unsigned int *dataLength, void **data);
 ...
 */
GNUNET_DataContainer *GNUNET_RPC_parameters_get_data_container_by_index (GNUNET_RPC_CallParameters * param,
                                                 unsigned int i);
 ...
 */
GNUNET_DataContainer *GNUNET_RPC_parameters_get_data_container_by_name (GNUNET_RPC_CallParameters * param,
                                             const char *name);
 ...
 */
void GNUNET_RPC_parameters_serialize (GNUNET_RPC_CallParameters * param, char *target);

/**
 * Deserialize parameters from buffer.
 */
GNUNET_RPC_CallParameters *GNUNET_RPC_parameters_deserialize (char *buffer, size_t size);

/**
 * How many bytes are required to serialize the param array?
 */
size_t GNUNET_RPC_parameters_get_serialized_size (GNUNET_RPC_CallParameters * param);
