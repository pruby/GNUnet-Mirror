...
fprintf(stderr, "setupUi()\n");
    ...
    spacerItem15 = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);
...
"If in doubt, leave the field empty. GNUnet will then try to determine your IP-Address.", 0, QApplication::UnicodeUTF8));
    ...
    checkBox->setText(QApplication::translate("SetupWizard", "Computer cannot receive inbound connections", 0, QApplication::UnicodeUTF8));
    ...
    radioButton->setText(QApplication::translate("SetupWizard", "Use denoted bandwidth for GNUnet", 0, QApplication::UnicodeUTF8));
    radioButton_2->setText(QApplication::translate("SetupWizard", "Share denoted bandwidth with other applications", 0, QApplication::UnicodeUTF8));
...
"It also helps to spread popular content over different peers to enhance availability.", 0, QApplication::UnicodeUTF8));
    checkBox_2->setText(QApplication::translate("SetupWizard", "Store migrated content", 0, QApplication::UnicodeUTF8));
    ...
    checkBox_3->setText(QApplication::translate("SetupWizard", "Open the enhanced configurator", 0, QApplication::UnicodeUTF8));
    ...
    checkBox_4->setText(QApplication::translate("SetupWizard", "Run gnunet-update", 0, QApplication::UnicodeUTF8));
